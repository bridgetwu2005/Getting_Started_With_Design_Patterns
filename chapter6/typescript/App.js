...
const CarWeatherDataDevice_1 = require("./CarWeatherDataDevice");
const HouseWeatherDataDevice_1 = require("./HouseWeatherDataDevice");
const WeatherData_1 = require("./WeatherData");
// initial WeatherData subject
let weather = new WeatherData_1.WeatherData();
// initial HouseWeatherDataDevice Observer and register WeatherData
let houseDeviceObserver = new HouseWeatherDataDevice_1.HouseWeatherDataDevice();
...
let carDeviceObserver = new CarWeatherDataDevice_1.CarWeatherDataDevice();
