...
const PotatoChip_1 = require("./PotatoChip");
const ShoppingCart_1 = require("./ShoppingCart");
const SpringWater_1 = require("./SpringWater");
//initialized product
let potatoChip = new PotatoChip_1.PotatoChip(2);
let springWater = new SpringWater_1.SpringWater(3);
//ShoppingCart pay by CreditCard
console.log("=== ShoppingCart pay by CreditCard ==");
let shoppingCartPayByCreditCard = new ShoppingCart_1.ShoppingCart();
...
let shoppingCartPayByApplePay = new ShoppingCart_1.ShoppingCart();
//add product to ShoppingCart
