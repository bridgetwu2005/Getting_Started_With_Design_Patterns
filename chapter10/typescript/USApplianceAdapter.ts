 ...
 * @Author: Bridget
 */
export class USApplianceAdapter extends EuropeanAppliance {

    usCoffeeMachine: USCoffeeMachine;

    constructor(usCoffeeMachine: USCoffeeMachine) { 
        // must call super()
        super(); 
     ...
     */
    private convertEuropeanToUSVolt(volt: number, diff: number): number {
        return volt - diff;
    }
