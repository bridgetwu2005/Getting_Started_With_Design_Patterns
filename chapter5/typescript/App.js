...
const PepperoniPizza_1 = require("./PepperoniPizza");
const PizzaRequest_1 = require("./PizzaRequest");
//order PepperoniPizza
let pepperoniPizza = new PepperoniPizza_1.PepperoniPizza();
let repperoniPizzaRequest = new PizzaRequest_1.PizzaRequest();
pepperoniPizza.order(repperoniPizzaRequest);
console.log();
//order CheesePizza with additional topping and sauce
let cheesePizza = new CheesePizza_1.CheesePizza();
let cheesePizzaRequest = new PizzaRequest_1.PizzaRequest();
